...
namespace WinFormsApp1
{
    ...
    {
        private SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\DELL\Documents\emp2.mdf;Integrated Security=True;Connect Timeout=30");
